...
public class HombreLobo extends Enemigo {
    ...
    public HombreLobo(String nombre, String descripcion, int nivel, int vida, int ataque, int defensa, int velocidad, int experiencia, boolean estado, String AtaqueEspecial)
    {
