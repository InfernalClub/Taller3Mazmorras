...
public class Vampiro extends Enemigo {
    ...
    public Vampiro(String nombre, String descripcion, int nivel, int vida, int ataque, int defensa, int velocidad, int experiencia, String estado, String AtaqueEspecial) {
